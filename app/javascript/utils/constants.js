...
export const exportInventoryPdfDataUrl =
  baseUrl + "api/v1/inventory_export_pdf";
export const inventoryURL = baseUrl + "api/v1/inventory";
...
export const unCalcBillURL = baseUrl + "api/v1/uncalc_bills";
export const calculateBillURL = baseUrl + "api/v1/calculate_bill";
export const lastBillDateURL = baseUrl + "api/v1/last_bill_date";
export const exportReceivePaymentCSVDataUrl =
  baseUrl + "api/v1/received_payments_csv_export";
export const billReportURL = baseUrl + "api/v1/export_bill_report";
export const billAmountReportURL = "api/v1/export_bill_amount_report";
export const billsReportURL = baseUrl + "api/v1/export_bills_report";
export const billURL = baseUrl + "api/v1/bills";
export const exportStockCSVDataUrl = baseUrl + "api/v1/export_stock_csv";
export const responsibleCategoryURL = baseUrl + "api/v1/responsible_category";
